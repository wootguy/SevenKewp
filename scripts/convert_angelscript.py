...
terms = [
	...
	('g_PlayerFuncs.FindPlayerByIndex', 'UTIL_PlayerByIndex'),
	('g_EntityFuncs.DispatchKeyValue', 'DispatchKeyValue'),
	('g_EntityFuncs.FireTargets', 'FireTargets'),
	...
	('g_EntityFuncs.Create', 'CBaseEntity::Create'),
	('CreateExplosion', 'ExplosionCreate'),
	...
	('g_Game.AlertMessage', 'ALERT'),
	('g_EntityFuncs.FindEntityByTargetname', 'UTIL_FindEntityByTargetname'),
