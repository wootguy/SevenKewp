...
//  DEFINE_FIELD( CShotgun, m_iShotgunShell, FIELD_INTEGER ),
	...
	DEFINE_FIELD( CMassn, m_iAssassinHead, FIELD_INTEGER ),
	DEFINE_FIELD( CMassn, m_flLastShot, FIELD_TIME ),
	DEFINE_FIELD( CMassn, m_fStandingGround, FIELD_BOOLEAN ),
	DEFINE_FIELD( CMassn, m_flStandGroundRange, FIELD_FLOAT ),
};
