...
enum
{
	SCHED_TORCH_ALLY_SUPPRESS = LAST_COMMON_SCHEDULE + 1,
...
class COFTorchAlly : public CTalkSquadMonster
{
public:
	void Spawn( void );
	void Precache( void );
...
IMPLEMENT_CUSTOM_SCHEDULES( COFTorchAlly, CTalkSquadMonster );
...
void COFTorchAllyRepel::RepelUse ( CBaseEntity *pActivator, CBaseEntity *pCaller, USE_TYPE useType, float value )
{
	...
	*/
	...
	auto pGrunt = static_cast<COFTorchAlly*>( pEntity->MyTalkSquadMonsterPointer( ) );
