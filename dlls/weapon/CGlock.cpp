...
void CGlock::GlockFire( float flSpread , float flCycleTime, BOOL fUseAutoAim )
{
	...
	Vector vecDir;
	vecDir = m_pPlayer->FireBulletsPlayer( 1, vecSrc, vecAiming, Vector( flSpread, flSpread, flSpread ), 8192, BULLET_PLAYER_9MM, 0, 0, m_pPlayer->pev, m_pPlayer->random_seed, 0, BULLETPRED_EVENT );
	lagcomp_end();
