...
public:
	...
	int		m_iClip;											// number of shots left in the primary weapon clip, -1 = it's not used
	int		m_iClip2;											// number of shots left in the secondary weapon clip, -1 = it's not used
