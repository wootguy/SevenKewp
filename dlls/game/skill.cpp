...
HashMap<float> g_defaultMonsterHealthMap; // default hp for the map
HashMap<float> g_defaultMonsterHealthServer; // default hp for the server
HashMap<skill_cvar_t*> g_skillCvars;
...
skill_cvar_t skill_cvars[] = {
	...
	DECL_SKILL_CVAR(sk_plr_556_bullet, CVAR_TYPE_DAMAGE),
	DECL_SKILL_CVAR(sk_plr_762_bullet, CVAR_TYPE_DAMAGE),
	...
	DECL_SKILL_CVAR(sk_ammo_max_762, CVAR_TYPE_ITEM),
...
void RefreshSkillData(bool mapSkills) {
	...
	HashMap<float>& hpDict = mapSkills ?
		g_defaultMonsterHealthMap : g_defaultMonsterHealthServer;

	hpDict.clear();

	hpDict.put("cycler", 80000);
	hpDict.put("hornet", 1);
	hpDict.put("monster_alien_babyvoltigore", 80);
	hpDict.put("monster_alien_controller", gSkillData.sk_controller_health);
	hpDict.put("monster_alien_grunt", gSkillData.sk_agrunt_health);
	hpDict.put("monster_alien_slave", gSkillData.sk_islave_health);
	hpDict.put("monster_alien_tor", gSkillData.sk_tor_health);
	hpDict.put("monster_alien_voltigore", gSkillData.sk_voltigore_health);
	hpDict.put("monster_apache", gSkillData.sk_apache_health);
	hpDict.put("monster_assassin_repel", gSkillData.sk_massassin_health);
	hpDict.put("monster_babycrab", gSkillData.sk_headcrab_health * 0.25);
	hpDict.put("monster_babygarg", gSkillData.sk_babygargantua_health);
	hpDict.put("monster_barnacle", gSkillData.sk_barnacle_health);
	hpDict.put("monster_barney", gSkillData.sk_barney_health);
	hpDict.put("monster_bigmomma", gSkillData.sk_bigmomma_health);
	hpDict.put("monster_blkop_osprey", gSkillData.sk_osprey_health);
	hpDict.put("monster_blkop_apache", gSkillData.sk_apache_health);
	hpDict.put("monster_bloater", 40);
	hpDict.put("monster_bodyguard", gSkillData.sk_hgrunt_health);
	hpDict.put("monster_bullchicken", gSkillData.sk_bullsquid_health);
	hpDict.put("monster_chumtoad", 100);
	hpDict.put("monster_cleansuit_scientist", gSkillData.sk_scientist_health);
	hpDict.put("monster_cockroach", 1);
	hpDict.put("monster_flyer_flock", 100);
	hpDict.put("monster_furniture", 80000);
	hpDict.put("monster_gargantua", gSkillData.sk_gargantua_health);
	hpDict.put("monster_generic", 8);
	hpDict.put("monster_gman", 100);
	hpDict.put("monster_gonome", gSkillData.sk_gonome_health);
	hpDict.put("monster_grunt_ally_repel", gSkillData.sk_hgrunt_health);
	hpDict.put("monster_grunt_repel", gSkillData.sk_hgrunt_health);
	hpDict.put("monster_headcrab", gSkillData.sk_headcrab_health);
	hpDict.put("monster_houndeye", gSkillData.sk_houndeye_health);
	hpDict.put("monster_human_assassin", gSkillData.sk_hassassin_health);
	hpDict.put("monster_human_grunt", gSkillData.sk_hgrunt_health);
	hpDict.put("monster_human_grunt_ally", gSkillData.sk_hgrunt_health);
	hpDict.put("monster_human_medic_ally", gSkillData.sk_hgrunt_health);
	hpDict.put("monster_human_torch_ally", gSkillData.sk_hgrunt_health);
	hpDict.put("monster_hwgrunt", gSkillData.sk_hwgrunt_health);
	hpDict.put("monster_hwgrunt_repel", gSkillData.sk_hwgrunt_health);
	hpDict.put("monster_ichthyosaur", gSkillData.sk_ichthyosaur_health);
	hpDict.put("monster_kingpin", gSkillData.sk_kingpin_health);
	hpDict.put("monster_leech", gSkillData.sk_leech_health);
	hpDict.put("monster_male_assassin", gSkillData.sk_massassin_health);
	hpDict.put("monster_medic_ally_repel", gSkillData.sk_hgrunt_health);
	hpDict.put("monster_miniturret", gSkillData.sk_miniturret_health);
	hpDict.put("monster_nihilanth", gSkillData.sk_nihilanth_health);
	hpDict.put("monster_osprey", gSkillData.sk_osprey_health);
	hpDict.put("monster_otis", gSkillData.sk_otis_health);
	hpDict.put("monster_pitdrone", gSkillData.sk_pitdrone_health);
	hpDict.put("monster_rat", 8);
	hpDict.put("monster_robogrunt", gSkillData.sk_hgrunt_health * 5);
	hpDict.put("monster_robogrunt_repel", gSkillData.sk_hgrunt_health * 5);
	hpDict.put("monster_scientist", gSkillData.sk_scientist_health);
	hpDict.put("monster_sentry", gSkillData.sk_sentry_health);
	hpDict.put("monster_shockroach", gSkillData.sk_shockroach_health);
	hpDict.put("monster_shocktrooper", gSkillData.sk_shocktrooper_health);
	hpDict.put("monster_sitting_scientist", gSkillData.sk_scientist_health);
	hpDict.put("monster_snark", gSkillData.sk_snark_health);
	hpDict.put("monster_sqknest", 100);
	hpDict.put("monster_stukabat", gSkillData.sk_stukabat_health);
	hpDict.put("monster_tentacle", 4000);
	hpDict.put("monster_torch_ally_repel", gSkillData.sk_hgrunt_health);
	hpDict.put("monster_turret", gSkillData.sk_turret_health);
	hpDict.put("monster_zombie", gSkillData.sk_zombie_health);
	hpDict.put("monster_zombie_barney", gSkillData.sk_zombie_health);
	hpDict.put("monster_zombie_soldier", gSkillData.sk_zombie_health);
}
...
float GetDefaultHealth(const char* monstertype, bool mapSkills) {
	...
	float* defaultHp = hpDict.get(monstertype);
